...
alias userver='sudo ~/bin/containerized_ubuntu_server.sh'
# dslr as webcam aliases
...
__conda_setup="$('/home/dylan/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
export PATH="$PATH:$HOME/repos/llvm-project/build/bin"
export PATH="$PATH:/opt/nvim-linux64/bin"
export PATH="$PATH:~/.config/emacs/bin"
export PATH="$PATH:/opt/blender-4.4.3-linux-x64"
